...
#include "../include/routines/quench.h"
...
int main(int argc, char** argv) {
    ...
    double target_temperature = run_config["target_temperature"].get<double>();
    double cooling_rate = run_config["cooling_rate"].get<double>();
    ...
    runNVTRescalingQuench(*particle, dt_dimless, rescale_freq, target_temperature, temperature, cooling_rate);
