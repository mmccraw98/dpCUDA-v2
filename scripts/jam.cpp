...
int main() {
    ...
    BidisperseDiskConfig config(0, 1024, 1.0, 1e6, 2.0, 0.6, neighbor_cutoff_multiplier, neighbor_displacement_multiplier, num_particles_per_cell, cell_displacement_multiplier, "cell", 256, 1.4, 0.5);
    ...
    std::string root_path = "/home/mmccraw/dev/data/24-11-08/jamming/40";
    ...
    std::vector<LogGroupConfig> log_group_configs = {
        ...
        config_from_names_lin_everyN({"step", "PE", "phi"}, 1, "energy"),  // saves the energy data to the energy file
