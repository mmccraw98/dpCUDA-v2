...
int main() {
    ...
    std::string source_path = "/home/mmccraw/dev/data/24-11-08/jamming/43/jamming/";
    std::string target_path = "/home/mmccraw/dev/data/24-11-08/jamming/43/dynamics-c1e-3-t1e-4/";
    ...
    double decompression_amount = 1e-3;
