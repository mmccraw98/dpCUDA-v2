...
struct BidisperseDiskConfig : public BidisperseParticleConfig {
    ...
    BidisperseDiskConfig(long seed, long n_particles, double mass, double e_c, double n_c,
        ...
        : BidisperseParticleConfig(seed, n_particles, mass, e_c, n_c, packing_fraction, neighbor_cutoff_multiplier, neighbor_displacement_multiplier, cell_size_multiplier, cell_displacement_multiplier, neighbor_list_update_method, particle_dim_block, size_ratio, count_ratio) {
            type_name = "Disk";
        }
};
