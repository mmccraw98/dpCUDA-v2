...
int main() {
    ...
    std::string output_path = "/home/mmccraw/dev/data/25-02-01/loading-debugging/rb/test-2";
    std::string input_path = "/home/mmccraw/dev/data/25-02-01/loading-debugging/rb/test";

    RigidBumpy rigid_bumpy;
    rigid_bumpy.load(input_path, "restart");
